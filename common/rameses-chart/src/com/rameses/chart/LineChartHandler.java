...
public abstract class LineChartHandler extends AbstractChartHandler {
    ...
    public JFreeChart createChart() {
        ...
        if ( isDisplay3d() ) {
            chart = ChartFactory.createLineChart3D( title, xlabel, ylabel, dataset, orientation, legend, tooltips, urls );
        } else {
            chart = ChartFactory.createLineChart( title, xlabel, ylabel, dataset, orientation, legend, tooltips, urls );
        }
