...
(function($) {
    ...
    $rootDiv = $('<div class="root-menu-div" style="position:absolute;top:0;left:0;"></div>'), //create main menu div
    defaults = {
        // $.Menu options
        showDelay : 200,
        hideDelay : 200,
    ...
    $.extend($.MenuItem, {
        prototype : {
            ...
            addSubMenu : function(menu) {
                ...
                var a = $('<span class="menu-item-arrow" ></span>')[0];
    ...
    $.extend($.fn, {
        ...
        menu : function(options, items, targetElm) {
            return this.each(function() {
                if ( items && items.constructor == Array )
                ...
                $(function(){
                    if (targetElm && targetElm.trim() != '') {
                        var target = $('.' + targetElm);
                        if (target[0]) {
                            $rootDiv.appendTo(target);
                        }
                    }
                    else {
